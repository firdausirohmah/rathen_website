...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset/css/display.css') }}"
    />
  </head>
  <body>
    ...
    <div class="app2">
      <div class="cardList2">
        <button class="cardList2__btn btn btn--left btn-slied">
          <div class="icon">
            <svg>
        ...
        <div class="cards__wrapper2">
          <div class="card2 current--card">
        ...
        <button class="cardList2__btn btn btn--right btn-slied">
          <div class="icon">
            <svg>
      ...
      <div class="app2__bg">
        <div class="app2__bg__image current--image">
          <!-- <img
            src="https://source.unsplash.com/Z8dtTatMVMw"
            alt=""
          /> -->
        </div>
        <div class="app2__bg__image next--image">
          <!-- <img
            src="https://source.unsplash.com/9dmycbFE7mQ"
            alt=""
          /> -->
        </div>
        <div class="app2__bg__image previous--image">
          <!-- <img
            src="https://source.unsplash.com/m7K4KzL5aQ8"
            alt=""
          /> -->
    ...
    <script src="{{ asset('asset/js/courasel.js') }}"></script>
  </body>
</html>
